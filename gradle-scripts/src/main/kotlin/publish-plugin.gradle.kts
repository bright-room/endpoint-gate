    ...
    publications {
        ...
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                ...
                url by "https://github.com/bright-room/endpoint-gate"

                issueManagement {
                    url by "https://github.com/bright-room/endpoint-gate/issues"
                }
                ...
                scm {
                    connection by "scm:git:git://github.com/bright-room/endpoint-gate.git"
                    developerConnection by "scm:git:git@github.com:bright-room/endpoint-gate.git"
                    url by "https://github.com/bright-room/endpoint-gate"
                }
            }
        }
