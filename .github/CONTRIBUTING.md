# CONTRIBUTING.md for `endpoint-gate`

Thank you! We welcome contributions to `endpoint-gate` 🎉

Before contributing to this project, please discuss the changes you wish to make via [Issues](https://github.com/bright-room/endpoint-gate/issues). This helps maintain the project's consistency and ensures smooth collaboration.

## 💡 How to Contribute

### 1. Create or Check Issues
- If you want to add a new feature or fix a bug, first check the existing [Issues](https://github.com/bright-room/endpoint-gate/issues) to see if a related issue already exists.
...
- Fork the `endpoint-gate` repository and work on your own fork.
