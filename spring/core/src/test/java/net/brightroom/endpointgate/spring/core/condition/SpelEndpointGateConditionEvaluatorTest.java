...
class SpelEndpointGateConditionEvaluatorTest {

  private final SpelEndpointGateConditionEvaluator evaluator =
      new SpelEndpointGateConditionEvaluator(true);
  ...
  void evaluate_returnsTrue_whenExpressionIsInvalid_failOnErrorFalse() {
    SpelEndpointGateConditionEvaluator failOpenEvaluator =
        new SpelEndpointGateConditionEvaluator(false);
